...
public class JavaKafkaProducer {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (true) {
            ...
            producer.send(new ProducerRecord<String, String>(topic, "{\"id\":\"1\",\"name\":\"LiMing\",\"age\":17,\"school\":\"北京大学\",\"subject\":\"bigdata\",\"time\":".concat(System.currentTimeMillis() + "}")), new Callback() {
                @Override
